...
namespace Utils
{
    public class LoggedHttpHandler : DelegatingHandler
    {
        private readonly string[] _types = {"html", "text", "xml", "json", "txt", "x-www-form-urlencoded"};

        public LoggedHttpHandler(HttpMessageHandler innerHandler = null) : base(
            ...
            CancellationToken cancellationToken)
        {
            ...
            Debug.WriteLine($"{msg} Path: {req.RequestUri.AbsoluteUri}");
